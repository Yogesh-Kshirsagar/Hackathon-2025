...
const HomePage = () => {
  ...
  const chartData = {
    ...
    datasets: [
      ...
      {
        label: 'Expenses',
        data: [2000, 2500, 1500, 3000, 3500, 4000, 4500],
        fill: false,
      ...
      {
        label: 'Savings',
        data: [2000, 2000, 1500, 2000, 2500, 3000, 3500],
        fill: false,
        backgroundColor: 'rgba(79, 197, 68, 0.2)',
        borderColor: 'rgba(150, 248, 120, 1)',
        borderWidth: 2,
      },
    ],
  };
        ...
        <div className="flex items-center gap-6 relative" ref={dropdownRef}>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="flex justify-center gap-8 mt-6 text-sm select-none text-gray-600 font-medium">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="space-y-4">
                ...
                {monthlyPayment !== null && (
                  <div className="text-center text-lg font-semibold text-green-700 mt-2 select-text">
