                      ...
                      <tr key={loan.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                            ${parseFloat(loan.interestRate) > 10 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'}">
                            {loan.interestRate}
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg">
                  <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
                      <div>
                        ...
                        <input name="fullName" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                      </div>

                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Aadhar</label>
                        <input name="aadhar" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                      </div>

                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">PAN</label>
                        <input name="pan" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                      </div>
                      ...
                      {loanType === "agri" && (
                        <>
                          <div>
                            ...
                            <input name="totalLand" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="number" onChange={handleChange} />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Crop Type</label>
                            <input name="cropType" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Zone / Area</label>
                            <input name="zone" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Avg. Cultivation Profit</label>
                            <input name="avgProfit" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                          </div>
                        </>
                      )}
                      ...
                      {loanType === "business" && (
                        <>
                          <div>
                            ...
                            <input name="businessType" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Seasonal / Regular</label>
                            <select name="seasonalRegular" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" onChange={handleChange}>
                          ...
                          <div>
                            ...
                            <input name="inventoryValue" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="number" onChange={handleChange} />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Yearly Income</label>
                            <input name="yearlyIncome" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="number" onChange={handleChange} />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">GST Details</label>
                            <input name="gstDetails" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-1">Bank Details</label>
                            <input name="bankDetails" className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400" type="text" onChange={handleChange} />
                          </div>
                        </>
                      )}
